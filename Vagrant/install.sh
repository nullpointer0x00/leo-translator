...
mysql -u root -ppassword -e "CREATE USER 'leo'@'%' IDENTIFIED BY 'leopass';GRANT ALL ON *.* TO 'leo'@'%';FLUSH PRIVILEGES;"
mysql -u root -ppassword -e "CREATE DATABASE Uebersetzung;"
